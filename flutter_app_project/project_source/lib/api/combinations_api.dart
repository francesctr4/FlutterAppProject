...
import 'package:project_source/models/combinations_class.dart';
import 'package:http/http.dart' as http;

Future<List<AllStation>> apiLoadLines()async{
  final uri = Uri.parse("https://api.tmb.cat/v1/transit/estacions?app_id=9a0ad75d&app_key=286c514e860aba9c094078dcf4a5d4c4");
